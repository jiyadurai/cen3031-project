...
export default function FeedPage({page, setPage, user, setUser}) {
  ...
  useEffect(() => {
    const fetchEvents = async () => {
      ...
      const fakeEvents = [
        { id: '1', title: 'Yoga on the Lawn', time: '9:00 AM', tag: '#wellness', posts: [{Title: 'Let’s gooo 🐊🔥', Description: 'Meet me by the fountain', Picture: 'https://picsum.photos/800/600'}, {Title: 'Let’s gooo 🐊🔥', Description: 'Meet me by the fountain', Picture: 'https://picsum.photos/800/600'}, {Title: 'Let’s gooo 🐊🔥', Description: 'Meet me by the fountain', Picture: 'https://picsum.photos/800/600'}]},
        { id: '2', title: 'Career Fair', time: '1:00 PM', tag: '#career', posts: [{Title: 'Squad pulling up tonight 💃🏾', Description: 'We linking at Turlington at 6PM sharp', Picture: 'https://picsum.photos/800/600'}, {Title: 'Squad pulling up tonight 💃🏾', Description: 'We linking at Turlington at 6PM sharp', Picture: 'https://picsum.photos/800/600'}, {Title: 'Squad pulling up tonight 💃🏾', Description: 'We linking at Turlington at 6PM sharp', Picture: 'https://picsum.photos/800/600'}]},
        { id: '3', title: 'Trivia Night', time: '7:00 PM', tag: '#fun', posts: [{Title: 'First Gator Pulse meetup 🐊💬', Description: 'Come chill, meet new people, and vibe with us 🎶', Picture: 'https://picsum.photos/800/600'}]},
